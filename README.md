...
```shell
kubectl apply -f https://raw.githubusercontent.com/12ozCode/hairpin-proxy/refs/heads/master/manifest/deploy.yml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/12ozCode/hairpin-proxy/refs/heads/master/manifest/deploy-etchosts-daemonset.yml
```
